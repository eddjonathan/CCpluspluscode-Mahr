/*
 *
 *  $Id: Neighbor.h,v 15d600891648 2010/06/24 13:22:58 michael $
 *
...
class Neighbor {
 ...
 public:
  ...
  Neighbor(const Neighbor&);
     ...
     bool CellTypeEquals(int) const;
     bool CellStiffnessEquals(int) const;
  ...
  void XMLAdd(xmlNodePtr) const;
    ...
    Cell *cell;    // ***** I MOVED THESE TWO FROM PROTECT (above) to HERE ******* //
    Node *nb1, *nb2;
