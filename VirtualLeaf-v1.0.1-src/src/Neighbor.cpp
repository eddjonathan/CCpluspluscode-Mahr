...
static const std::string _module_id("$Id: Neighbor.cpp,v 15d600891648 2010/06/24 13:22:58 michael $");
...
bool Neighbor::CellTypeEquals(int i) const { return cell->CellType() == i; }
bool Neighbor::CellStiffnessEquals(int i) const { return cell->Stiffness() == i; }
