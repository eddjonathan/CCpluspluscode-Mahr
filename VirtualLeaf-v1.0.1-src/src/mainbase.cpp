...
static const std::string _module_id("$Id: mainbase.cpp,v 3809c04020b4 2010/11/29 16:21:54 roeland $");
...
int MainBase::Save(const char *fname, const char *format, int sizex, int sizey)
{
  ...
  if (!QString(format).contains("PDF", Qt::CaseInsensitive)) {
    ...
    canvas.render(&painter, QRectF(), QRectF(-500,-800, 1000, 1200)); // NB Fiddle with these arguments if relative size of PDF images is important.
