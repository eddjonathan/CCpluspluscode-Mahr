...
**
** Created: Thu Jun 8 22:21:15 2017
...
const QMetaObjectExtraData OptionFileDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject OptionFileDialog::staticMetaObject = {
    { &Q3FileDialog::staticMetaObject, qt_meta_stringdata_OptionFileDialog,
      qt_meta_data_OptionFileDialog, &staticMetaObjectExtraData }
};
