...
//    par->rel_perimeter_stiffness=24;
    ...
    if(c->Index()==3||c->Index()==8||c->Index()==11||c->Index()==7||c->Index()==1||c->Index()==6||c->Index()==13) {c->SetStiffness(Z);}
    ...
    if  (c->Index()==0||c->Index()==2||c->Index()==4||c->Index()==5||c->Index()==9||c->Index()==10||c->Index()==12||c->Index()==14||c->Index()==15)
