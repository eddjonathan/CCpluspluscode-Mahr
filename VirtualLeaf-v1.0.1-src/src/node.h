/*
 *
 *  $Id: node.h,v 15d600891648 2010/06/24 13:22:58 michael $
 *
...
class Node : public Vector {
 ...
 public:
    ...
    Cell *cell;  // I ADDED TO ACCESS GETCELL() 
 ...
 //   Cell* getCell(void) const;
  ...
  Cell &getCell(const Neighbor &i);
    ...
    Cell* getCell(void) const { return cell; }
...
bool boundary;   // ****** I MOVED BOUNDARY FROM PRIVATE to HERE *********//
